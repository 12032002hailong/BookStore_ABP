...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 1f14fe12-2bbe-4fa2-9784-eb7594396238
```

> `1f14fe12-2bbe-4fa2-9784-eb7594396238` is the password of the certificate, you can change it to any password you want.
